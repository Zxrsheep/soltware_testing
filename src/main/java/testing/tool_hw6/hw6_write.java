...
public class hw6_write {

    public static void write(List<entity_hw6> list1,List<entity_hw6> list2 , int num1, int num2) {
        String fileName = "src/main/java/testing/excel/" + "hw6_result.xlsx";
        ExcelWriter excelWriter = null;
        try {
            // 这里 指定文件
            excelWriter = EasyExcel.write(fileName, entity_hw6.class).build();
    ...
    public static void write(List<entity_hw6> list, int num) {
        String fileName = "src/main/java/testing/excel/" + "hw6_result.xlsx";
        ExcelWriter excelWriter = null;
        try {
            // 这里 指定文件
